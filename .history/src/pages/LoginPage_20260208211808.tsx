...
export default function LoginPage() {
  ...
  // They said no need backend login.
  const onSubmit = async (data: LoginForm) => {
    console.log("Form submitted:", data);
    // You can show a toast/snackbar if you want, but not necessary.
  };
    ...
    >
      ...
      >
        <Grid container>
          ...
          >
            {/* You can replace this with your preferred illustration */}
            <Box
              component="img"
              src="file:///F:/my%20docs/Projects/webpage_login/public/undraw_web-development_f0tp.svg"
              alt="illustration"
              sx={{
                width: { xs: "100%", sm: "78%" },
                maxWidth: 520,
